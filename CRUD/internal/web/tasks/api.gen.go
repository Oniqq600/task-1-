...
type ServerInterface interface {
	...
	// Create a new task with a user ID
	// (POST /tasks/{user_id})
	PostTasksUserId(ctx echo.Context, userId int) error
}
...
func (sh *strictHandler) PostTasksUserId(ctx echo.Context, userId int) error {
